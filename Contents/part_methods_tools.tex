...
\scsubsubsection[
    ...
    \protect\scnmonographychapter{Глава 5.5. Конвергенция и интеграция искусственных нейронных сетей с базами знаний в интеллектуальных компьютерных системах нового поколения}
...
\input{Contents/part_methods_tools/src/autom_design_neural_network_logical_model}
