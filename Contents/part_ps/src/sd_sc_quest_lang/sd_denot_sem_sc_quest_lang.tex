...
\begin{scnsubstruct}
    ...
    \scnhaselementrole{ключевой sc-элемент}{Предметная область денотационной семантики Языка вопросов для ostis-систем}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Железнодорожный район Города Витебск, Октябрьский район Города Витебск, Первомайский район Города Витебск \scnrightcurlbrace}
                    \begin{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Смолевичский район является частью Минской области \scnrightcurlbrace}
                \end{scnindent}
            \end{scnhaselementrolelist}
        \end{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnrightcurlbrace Волковыск, Гродно, Мозырь и другие имели Магдебургское право \scnrightcurlbrace}
                \end{scnindent}
            \end{scnhaselementrolelist}
        \end{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Первый раздел Речи Посполитой был раньше Бородинского сражения \scnrightcurlbrace}
                    \begin{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Высота Горы Дзержинская --- 345 м \scnrightcurlbrace}
                \end{scnindent}
            \end{scnhaselementrolelist}
        \end{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    ...
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Территория Минской области больше Брестской \scnrightcurlbrace}
                    \begin{scnindent}
    ...
    \begin{scnrelfromset}{декомпозиция}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                \scnitem{\scnleftcurlbrace S состоит из P, Q, W. S переводит X и Y и выполняется раньше Z \scnrightcurlbrace}
                \begin{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                \scnitem{\scnleftcurlbrace Минск --- это столица, которая находится в РБ \scnrightcurlbrace}
                \begin{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Время в пути от города Минска до города Борисова меньше чем время в пути от города Минска до города Орша, потому что расстояние от города Минска меньше до города Борисова, чем до города Орша \scnrightcurlbrace}
                \end{scnindent}
            \end{scnhaselementrolelist}
        \end{scnindent}
        ...
        \begin{scnindent}
            ...
            \begin{scnhaselementrolelist}{пример}
                ...
                \begin{scnindent}
                    \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Расстояние от города Минска до города Борисова меньше расстояния от города Минска до города Орша, поэтому от города Минска до города Борисова время в пути меньше чем до города Орша \scnrightcurlbrace}
                \end{scnindent}
            \end{scnhaselementrolelist}
        \end{scnindent}
    \end{scnrelfromset}
    ...
    \begin{scnindent}
        ...
        \begin{scnhaselementrolelist}{пример}
            ...
            \begin{scnindent}
                \scnrelfrom{ответ на вопрос}{\scnleftcurlbrace Город Минск расположен на реке Свислочь, которая впадает в реку Березина, протекающую через город Светлогорск \scnrightcurlbrace}
            \end{scnindent}
        \end{scnhaselementrolelist}
    \end{scnindent}
