...
\scnnote{Пользовательский интерфейс - это компонент интеллектуальной системы, который подвержен частым изменениям из-за присутствия широкого круга пользователей с разным уровнем культуры использования и требованиями к программной системе.Создать пользовательский интерфейс, удовлетворяющий требованиям всех пользователей, возможно только путем создания гибких моделей такого интерфейса, которые затем могли бы быть интерпретированы путем интерпретации одной из платформ таких моделей.}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
...
\scnexplanation{Командный пользовательский интерфейс - это интерфейс, в котором команды передаются компьютерной системе с помощью командной строки, а затем выполняются}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
...
\scnexplanation{Графический пользовательский интерфейс - интерфейс, в котором команды передаются компьютерной системе косвенно через графические изображения}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
...
\scnexplanation{SILK-интерфейс - это интерфейс, в котором команды передаются компьютерной системе посредством анализа поведения человека}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
