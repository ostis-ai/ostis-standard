...
\scnexplanation{...интерфейс, в котором команды передаются компьютерной системе с помощью командной строки, а затем выполняются}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
...
\scnexplanation{...интерфейс, в котором команды передаются компьютерной системе косвенно через графические изображения}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
...
\scnexplanation{...интерфейс, в котором команды передаются компьютерной системе посредством анализа поведения человека}
\scnaddlevel{1}
\scnrelto{цитата}{\scncite{Zhukov2017}}
\scnaddlevel{-1}
