        ...
        \begin{scnsubstruct}
            ...
            \begin{scnindent}
                ...
                \begin{scnrelfromlist}{пример}
                    \scnitem{\scnfileitem{\textit{многоугольник} $\supset$ \textit{треугольник}}}
                    \begin{scnindent}
                    ...
                    \end{scnindent}
                    \scnitem{\scnfileitem{\textit{Si} |- \textit{ai} >| \textit{ei}}}
                    \begin{scnindent}
            ...
            \begin{scnindent}
                ...
                \end{scnindent}
            \end{scnindent}
            \bigskip\bigskip{\scnfilelong{\textit{треугольник $\ni$ Треугк(ТчкВ\char59ТчкС\char59ТчкD)\char59\char59\newlineТреугк(ТчкВ\char59ТчкС\char59ТчкD) $\Rightarrow$ сторона*:включение*: Отр(ТчкВ\char59ТчкC)\char59\char59}}}
            \begin{scnindent}
            ...
            \begin{scnindent}
                ...
                \end{scnindent}
            \end{scnindent}
            \bigskip\bigskip\newpage{\scnfilelong{\textit{Треугк(ТчкВ\char59ТчкС\char59ТчкD) $\Rightarrow$ сторона*:включение*:Отр(ТчкВ\char59ТчкС)\char59\char59}}}
            \begin{scnindent}
