\begin{SCn}
    ...
    \begin{scnsubstruct}
        ...
        \scnheader{SCg-текст. Иллюстрация к спецификации лексемы в базе знаний}
        \scneq{{\scnfileimage[20em]{Contents/part_kb/src/images/sd_natural_languages/lexeme_example_a.png}}}
        ...
        \begin{scnrelfromvector}{пример}
            \scnfileitem{Ниже приводятся возможные структуры синтаксических групп.
            \\В скобках указаны опциональные элементы.}
            \scnfileitem{Группа детерминанта:
                \begin{scnitemize}
            ...
            \scnfileitem{Наречная группа:
                ...
                \end{scnitemize}}
            \scnfileitem{Группа прилагательного:
                \begin{scnitemize}
            ...
            \scnfileitem{Временная группа:
                ...
                \end{scnitemize}}
            \scnfileitem{Группа комплементатора:
                \begin{scnitemize}
        ...
        \scnheader{правило спецификатора}
        \scntext{смотрите}{SCg-текст. Правило спецификатора}

        \scnheader{SCg-текст. Правило спецификатора}
        \scneq{{\scnfileimage[30em]{Contents/part_kb/src/images/sd_natural_languages/specifier_rule.png}}}

        \scnheader{правило адъюнкта}
        \scntext{смотрите}{SCg-текст. Правило адъюнкта}

        \scnheader{SCg-текст. Правило адъюнкта}
        \scneq{{\scnfileimage[30em]{Contents/part_kb/src/images/sd_natural_languages/adjunct_rule.png}}}

        \scnheader{правило комплемента}
        \scntext{смотрите}{SCg-текст. Правило комплемента}

        \scnheader{SCg-текст. Правило комплемента}
        \scneq{{\scnfileimage[30em]{Contents/part_kb/src/images/sd_natural_languages/complement_rule.png}}}
