    ...
    \begin{scnsubstruct}
        ...
        \begin{scnrelfromset}{базовые признаки классификации}
            ...
            \begin{scnindent}
                ...
                \scnrelfrom{включение}{постоянство существования обозначаемой сущности}
                \begin{scnindent}
                    \scnrelfrom{смотрите}{\textbf{Типология sc-элементов по постоянству обозначаемых сущностей\scnsupergroupsign}}
                \end{scnindent}
                \scnrelfrom{включение}{временность существования обозначаемой сущности}
                \scnrelfrom{включение}{статичность обозначаемой сущности}
                \begin{scnindent}
                ...
                \end{scnindent}
                \scnrelfrom{включение}{динамичность обозначаемой сущности}
                \begin{scnindent}
        ...
        \scnhaselement{обозначение sc-ласса}
        \begin{scnindent}
