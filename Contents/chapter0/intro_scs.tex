...
\bigskip
\scnendstruct \scnendsegmentcomment{Первый сегмент Введения в язык линейного представления знаний ostis-систем}
...
\bigskip
\scnendstruct \scnendsegmentcomment{Итоговый сегмент введения в SCs-код}
