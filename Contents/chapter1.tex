...
\scsection{Предметная область и онтология систем, основанных на обработке информации}
...
\scsubsubsection{Предметная область и онтология технологий эволюции интеллектуальных компьютерных систем}

\scsection{Предметная область и онтология семантических моделей компьютерных систем}
