...
\scsection{Предметная область и онтология методов и средств перманентной поддержки семантической совместимости ostis-систем в рамках Экосистемы OSTIS}

\scsection{Предметная область и онтология методов и средств перманентной поддержки способности ostis-систем самостоятельно взаимодействовать с другими ostis-системами и с пользователями в рамках Экосистемы OSTIS}
...
\scsection{Предметная область и онтология корпоративных ostis-систем, обеспечивающих организацию самостоятельного взаимодействия ostis-систем как между собой, так и с пользователями в рамках Экосистемы OSTIS}
...
\scsection{Логико-семантическая модель Метасистемы IMS.ostis}
