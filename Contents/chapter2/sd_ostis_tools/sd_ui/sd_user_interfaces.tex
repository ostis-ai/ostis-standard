...
\scnaddlevel{1}
\scnhaselement{пользовательский интерфейс IMS}
\scnaddlevel{1}
\scnidtf{пользовательский интерфейс Метасистемы IMS.ostis}
\scnaddlevel{-1}
...
\scnheader{стартовая страница пользовательского интерфейса IMS}
\scniselement{визуальная часть пользовательского интерфейса IMS}
	\scnaddlevel{1}
