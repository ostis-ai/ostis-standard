...
\input{Contents/chapter2/sd_ostis_sys_models/sd_ui/sd_ui_action}
\scsubsubsection{Предметная область и онтология элементарных интерфейсных пользовательских действий}
\input{Contents/chapter2/sd_ostis_sys_models/sd_ui/sd_ui_elem_action}
