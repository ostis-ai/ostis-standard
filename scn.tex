...
\makeatletter
\newcommand{\scnsegmentcaption}{\normalfont/*~\segcountertext сегмент Раздела~\@currentlabel.~\filldots/\hspace{0.5\textwidth}}
\makeatother

\newcommand{\scnrelfrom}[2]{
\settab$\bm{\Rightarrow}$\makediff{\arrowsize}{\itshape #1*}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{1}
\sethind
\settab{\itshape#2}\\
...
\settab$\bm{\Leftarrow}$\makediff{\arrowsize}{\itshape #1*}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{2}
\sethind 
...
\settab$\bm{\Rightarrow}$\makediff{\arrowsize}{\itshape #3*}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{2}
\sethind 
...
\newcommand{\scnrelfromvector}[2]{\scnrelfromcommonset{\langle}{\rangle}{#1}{#2}}

\newcommand{\scnreltocommonset}[4]{
\settab$\bm{\Leftarrow}$\makediff{\arrowsize}{\itshape #3*}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{2}
\sethind 
...
\settab$\bm{\Leftrightarrow}$\makediff{\arrowsize}{\itshape #1*}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{1}
\sethind 
...
\settab$\bm{\in}$\makediff{\insize}{\itshape #1'}:\\
\addtocounter{ind}{1}
\addtocounter{hind}{1}
\sethind 
\hspace{0.2em}\settab{\itshape #2}\\
...
%\newcommand{\scnstructinclusion}{\settab$\bm{\supset=}$}
...
\begin{adjustwidth}{\calctab+0.8em}{0em}
\justify
\setlength{\parindent}{0em}
\setlength{\itemindent}{0em}
\hspace{-0.8em}\normalfont /*#1*/
...
\chapter[#1]{/*~Раздел~ \thechapter.~\filldots/\vspace{\afterparlength}}}

\newcommand{\scsection}[1]{\clearpage
\section[#1]{/*~Раздел~\thesection.~\filldots/\vspace{\afterparlength}}}

\newcommand\scsubsection[1]{\clearpage
\subsection[#1]{/*~Раздел~ \thesubsection.~\filldots/\vspace{\afterparlength}}}
...
\subsubsection[#1]{/*~Раздел~ \thesubsubsection.~\filldots/\vspace{\afterparlength}}}
...
\paragraph[#1]{/*~Раздел~\theparagraph.~\filldots/\vspace{\afterparlength}}}
...
{\bfseries \normalfont \normalsize /*~Начало  Раздела~\@currentlabel.~\filldots/}
...
\newcommand{\scsupersectionbeginning}[1]{\bigskip \section*{/*~Начало раздела.~\filldots/}
\vspace{0.5\afterparlength}
\scnsectionheader{Начало Раздела "Документация Технологии OSTIS"}
}
