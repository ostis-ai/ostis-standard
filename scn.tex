...
\NewDocumentCommand\scnlist{>{\SplitList{;}}m}
   %{\ProcessList{#1}{\iffilemode\scnlistitem\else\scnfilelistitem\fi}}
...
\settab$\bm{\coloneqq}$\hspace{\calcdiff{\idtfsize}}{\itshape #1*}{\normalfont:}\\
\addtocounter{ind}{1}
...
\newcommand{\scnendstructcomment}[1]{\settab$\pmb{\}}$\makediff{\arrowsize}\scnsourcecomment{#1}}
