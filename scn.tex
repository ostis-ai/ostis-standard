...
\newcommand{\scnfragmentcaption}{\bfseries /*\filldots/\hspace{\textwidth}\vspace{\afterseglength}}
...
\chapter[\textit{#1}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}}

\newcommand{\scsection}[1]{\clearpage
\section[\textit{#1}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}}

\newcommand\scsubsection[1]{\clearpage
\subsection[\textit{#1}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}}

\WithSuffix\newcommand\scsubsection*[2]{\clearpage\subsection*{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
	\addcontentsline{toc}{subsection}{#1}
}

\newcommand{\scsubsubsection}[1]{\clearpage
\subsubsection[\textit{#1}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}}

\WithSuffix\newcommand\scsubsubsection*[2]{\clearpage\subsubsection*{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
	\addcontentsline{toc}{subsubsection}{#1}
}

\newcommand{\scparagraph}[1]{\clearpage
	\paragraph[\textit{#1}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}}
