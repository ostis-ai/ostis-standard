...
\cftsetindents{chapter}{0}{0}
\renewcommand{\cftsecpresnum}{\begin{lrbox}{\@tempboxa}}
\renewcommand{\cftsecaftersnum}{\end{lrbox}}
\cftsetindents{section}{\tabsize}{0}
\renewcommand{\cftsubsecpresnum}{\begin{lrbox}{\@tempboxa}}
\renewcommand{\cftsubsecaftersnum}{\end{lrbox}}
\cftsetindents{subsection}{\tabsize+\tabsize}{0}
\renewcommand{\cftsubsubsecpresnum}{\begin{lrbox}{\@tempboxa}}
\renewcommand{\cftsubsubsecaftersnum}{\end{lrbox}}
\cftsetindents{subsubsection}{\tabsize+\tabsize+\tabsize}{0}
\renewcommand{\cftparapresnum}{\begin{lrbox}{\@tempboxa}}
\renewcommand{\cftparaaftersnum}{\end{lrbox}}
\cftsetindents{paragraph}{\tabsize+\tabsize+\tabsize+\tabsize}{0}
\renewcommand{\cftsubparapresnum}{\begin{lrbox}{\@tempboxa}}
\renewcommand{\cftsubparaaftersnum}{\end{lrbox}}
\cftsetindents{subparagraph}{\tabsize+\tabsize+\tabsize+\tabsize+\tabsize}{0}
\renewcommand\cftchapafterpnum{\bigskip}
\renewcommand\cftsecafterpnum{\bigskip}
\renewcommand\cftsubsecafterpnum{\bigskip}
\renewcommand\cftsubsubsecafterpnum{\bigskip}
\renewcommand\cftparaafterpnum{\bigskip}
\renewcommand\cftsubparaafterpnum{\bigskip}
\makeatother
...
\makeatletter
\newcommand{\scnsegmentcaption}{\normalfont \bfseries /*~Сегмент~\theseg~ Раздела~\filldots/\hspace{0.5\textwidth}\normalfont}
\makeatother

%\makeatletter
%\newcommand{\scnsegmentcaptionbeginning}{\normalfont \bfseries /*~Сегмент~\theseg~Начала~Раздела~\@currentlabel~\filldots/\hspace{0.5\textwidth}\normalfont}
%\makeatother

\makeatletter
\newcommand{\scnsegmentcaptionbeginning}{\normalfont \bfseries /*~Сегмент~\theseg~Начала~Раздела~\filldots/\hspace{0.5\textwidth}\normalfont}
\makeatother
...
\scninlinesourcecommentpar{Завершили \textit{Раздел ``\@currentlabelname''}}
}
\makeatother
...
\newcommand{\scsubsubsection}[1]{\clearpage
\subsubsection[\textit{#1}]{/*~Раздел~\filldots/\vspace{\afterparlength}}}

%\WithSuffix\newcommand\scsubsubsection*[2]{\clearpage\subsubsection*{/*~Раздел~#2~\filldots/\vspace{\afterparlength}}
%\addcontentsline{toc}{subsubsection}{#1}
%}

\WithSuffix\newcommand\scsubsubsection*[2]{\clearpage\subsubsection*{/*~Раздел~\filldots/\vspace{\afterparlength}}
	\addcontentsline{toc}{subsubsection}{#1}
}
...
\newcommand{\scparagraph}[1]{\clearpage
	\paragraph[\textit{#1}]{/*~Раздел~\filldots/\vspace{\afterparlength}}}

%\newcommand{\scchapterfinish}[1]{\clearpage
%\section*{/*~Завершение раздела~\ref{#1}~\filldots/\vspace{\afterparlength}}}

\newcommand{\scchapterfinish}[1]{\clearpage
\section*{/*~Завершение раздела~\filldots/\vspace{\afterparlength}}}
...
\newcommand{\scsubsectionfinish}[1]{\clearpage
	\subsection*{/*~Завершение раздела~\filldots/\vspace{\afterparlength}}}
...
\newcommand{\scsubsubsectionfinish}[1]{\clearpage
	\subsubsection*{/*~Завершение раздела~\filldots/\vspace{\afterparlength}}}
...
\makeatletter
\newcommand{\scsectionbeginning}{\bigskip
	{\bfseries \normalsize /*~Начало  Раздела~\filldots/\hspace{0.5\textwidth}\normalfont}
	\scnsectionheader{Начало Раздела "\@currentlabelname"}
}
\makeatother
