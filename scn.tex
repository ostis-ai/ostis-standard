...
\newcommand{\scnpagenumber}[1]{
\scnrelfrom{номер страницы в распечатке Стандарта OSTIS}{#1}
}
...
\newcommand{\scsectionfamily}[2][]{\clearpage\chapter[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Семейство разделов}~\filldots/\vspace{\afterparlength}}
	\ifx&#1&
	\else
...
\newcommand{\scchapter}[2][]{\clearpage\chapter[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
\addtocontents{toc}{\vspace{\dimexpr -\toclineskip+0.1\baselineskip \relax}\parbox{\textwidth}{\begin{adjustwidth}{\tabsize}{0em}\begin{SCn}\protect#1\end{SCn}\end{adjustwidth}}
\vspace{\toclineskip}}
...
\section[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
...
\newcommand{\scseparatedfragment}[2][]{\clearpage\chapter[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
\addtocontents{toc}{\vspace{\dimexpr -\toclineskip+0.1\baselineskip \relax}\parbox{\textwidth}{\begin{adjustwidth}{\tabsize}{0em}\begin{SCn}\protect#1\end{SCn}\end{adjustwidth}}
\vspace{\toclineskip}}
...
\subsection[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
...
\subsubsection[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
...
\newcommand{\scparagraph}[2][]{\clearpage\paragraph[\hspace{-\tabsize}$\bullet$\makediff{\bulletsize}\textit{#2}]{/*~\textspaced{\large Раздел}~\filldots/\vspace{\afterparlength}}
\ifx&#1&
\else
