...
\makeatletter
\newcommand{\scnsegmentcaption}{\normalfont/*~Сегмент~\theseg~ Раздела~\@currentlabel.~\filldots/\hspace{0.5\textwidth}}
\makeatother
...
\chapter[\textit{\textbf{#1}}]{/*~Раздел~ \thechapter.~\filldots/\vspace{\afterparlength}}}

\newcommand{\scsection}[1]{\clearpage
\section[\textit{\textbf{#1}}]{/*~Раздел~\thesection.~\filldots/\vspace{\afterparlength}}}
