...
\input{Contents/title_part}             %готово

\include{Contents/part_intro}
%почти
%  \include{Contents/part_kb}                   %студенты
%  \include{Contents/part_ps}
%  \include{Contents/part_ui}                   %настя
%  \include{Contents/part_methods_tools}
%  \include{Contents/part_platform}
%  \include{Contents/part_support}              %готово
%  \include{Contents/part_ecosystem}            %настя
